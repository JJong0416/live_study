...
public class StaticSynchronizedMethod {
    public static void main(String[] args) {
        ...
        Thread thread3 = new Thread(() -> {
            System.out.println("스레드3시작 " + LocalDateTime.now());
    ...
    private static synchronized void syncStaticMethod1(String msg) {
        ...
        try {
            ...
            System.out.println(msg + "의 syncStaticMethod1 실행완료" + LocalDateTime.now());
    ...
    private static synchronized void syncStaticMethod2(String msg) {
        ...
        try {
            TimeUnit.SECONDS.sleep(5);
            System.out.println(msg + "의 syncStaticMethod2 실행완료" + LocalDateTime.now());
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
    }
